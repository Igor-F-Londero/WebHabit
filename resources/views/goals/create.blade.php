                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text"
                                ...
                                :value="old('title')"
                                placeholder="Ex: Meditar 20 vezes em 30 dias"
                                required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="target_count" name="target_count" type="number"
                                ...
                                placeholder="Ex: 20"
                                required />
                            <p class="mt-1 text-xs text-gray-400">Quantidade de check-ins necessários para concluir a meta.</p>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                placeholder="Motivação ou observações (opcional)">{{ old('description') }}</textarea>
